...
@php
    ...
    $variants = [
        ...
        'warning' => 'bg-warning text-warning-foreground shadow-xs hover:bg-warning/70',
        'destructive' => 'bg-destructive text-white shadow-xs hover:bg-destructive/70 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40',
        'outline' => 'border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
        'secondary' => 'bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80',
        'success' => 'bg-success text-success-foreground shadow-xs hover:bg-success/70',
