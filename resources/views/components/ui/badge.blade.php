...
@php
    ...
    $variants = [
        ...
        'warning' => 'border-transparent bg-warning text-warning-foreground [a&]:hover:bg-warning/70',
        'secondary' => 'border-transparent bg-secondary text-secondary-foreground [a&]:hover:bg-secondary/90',
        'success' => 'border-transparent bg-success text-success-foreground [a&]:hover:bg-success/70',
